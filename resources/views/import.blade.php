            ...
            <table id="data-table" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php foreach($list as $k) { ?>
                        <tr>
                            <td>IMPORT-0000<?= $k->id ?></td>
                            <td><?= $k->created_at ?></td>
                            <td>Administrator</td>
                            <td><?= $k->number_of_rows ?></td>
                            <td class="text-center"><button class="btn btn-primary btn-outline-primary" onclick="import_details()">Viwe Details</button></td>
                        </tr>
                     <?php } ?>
                  </tbody>
                  <tfoot>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="input-group mb-3">
                   <input type="text" class="form-control" placeholder="Select Date" data-toggle="datepicker" name="date" autocomplete="off" >
